...
// Package graphql provides a GraphQL interface to MAY node data.
package graphql
...
// Account represents an MAY account at a particular block.
type Account struct {
...
// Transaction represents an MAY transaction.
...
type CallData struct {
	From     *common.Address // The MAY address the call is from.
	To       *common.Address // The MAY address the call is to.
