...
import "github.com/MAY/go-MAY/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main MAY network.
var MainnetBootnodes = []string{
	// MAY Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/MAY/discv4-dns-lists for more
// information.
