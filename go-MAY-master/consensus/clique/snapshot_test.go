...
// mapped from textual names used in the tests below to actual MAY private
...
// address retrieves the MAY address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the MAY address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/MAY/go-MAY/issues/17593). Whilst this
