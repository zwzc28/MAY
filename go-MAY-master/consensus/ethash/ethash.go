...
// all blocks' seal as valid, though they still have to conform to the MAY
// consensus rules.
...
// still have to conform to the MAY consensus rules.
...
// they still have to conform to the MAY consensus rules.
