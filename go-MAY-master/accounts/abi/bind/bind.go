...
// Package bind generates MAY contract Go bindings.
//
// Detailed usage document and tutorial available on the go-MAY Wiki page:
// https://github.com/MAY/go-MAY/wiki/Native-DApps:-Go-bindings-to-MAY-contracts
package bind
