...
func (mc *mockCaller) CallContract(ctx context.Context, call MAY.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call MAY.CallMsg) ([]byte, error) {
