...
import (
	...
	"github.com/MAY/go-MAY/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an MAY
...
func (eth *MAY) startBloomHandlers(sectionSize uint64) {
...
// for the MAY header bloom filters, permitting blazing fast filtering.
