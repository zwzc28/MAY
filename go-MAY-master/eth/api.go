...
// PublicMAYAPI provides an API to access MAY full node-related
// information.
type PublicMAYAPI struct {
	e *MAY
}

// NewPublicMAYAPI creates a new MAY protocol API for full nodes.
func NewPublicMAYAPI(e *MAY) *PublicMAYAPI {
	return &PublicMAYAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicMAYAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicMAYAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicMAYAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().HashRate())
}

// ChainId is the EIP-155 replay-protection chain id for the current MAY chain config.
func (api *PublicMAYAPI) ChainId() (hexutil.Uint64, error) {
...
func NewPublicMinerAPI(e *MAY) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *MAY) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of MAY full node-related APIs
...
// admin methods of the MAY service.
func NewPrivateAdminAPI(eth *MAY) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of MAY full node APIs exposed
...
// related public debug methods of the MAY service.
func NewPublicDebugAPI(eth *MAY) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of MAY full node APIs exposed over
...
// private debug methods of the MAY service.
func NewPrivateDebugAPI(eth *MAY) *PrivateDebugAPI {
