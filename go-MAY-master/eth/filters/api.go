...
// information related to the MAY protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(MAY.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as MAY.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria MAY.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(MAY.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
