...
// stateObject represents an MAY account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of MAY address of the account
	data     Account
	db       *StateDB
...
// Account is the MAY consensus representation of accounts.
