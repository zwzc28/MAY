...
// Package state provides a caching layer atop the MAY state trie.
package state
...
// StateDB structs within the MAY protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/MAY/go-MAY/pull/16485#issuecomment-380438527),
