...
import (
	...
	"github.com/MAY/go-MAY/crypto/blake2b"
	"github.com/MAY/go-MAY/crypto/bls12381"
	"github.com/MAY/go-MAY/crypto/bn256"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled MAY
...
// PrecompiledContractsByzantium contains the default set of pre-compiled MAY
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled MAY
...
// PrecompiledContractsYoloV2 contains the default set of pre-compiled MAY
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.MAY.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
