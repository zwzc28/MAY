...
// Package forkid implements EIP-2124 (https://eips.MAY.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the MAY fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the MAY fork ID from an existing chain instance.
