...
// Package core implements the MAY consensus protocol.
package core
...
// available in the database. It initialises the default MAY Validator and
// Processor.
