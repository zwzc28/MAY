...
// Package types contains data types related to MAY consensus.
package types
...
// Header represents a block header in the MAY blockchain.
type Header struct {
...
// Block represents an entire block in the MAY blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the MAY RLP block format.
