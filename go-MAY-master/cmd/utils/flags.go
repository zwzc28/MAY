...
// Package utils contains internal helper functions for go-MAY commands.
package utils
...
import (
	...
	"github.com/MAY/go-MAY/common/fdlimit"
	...
	"github.com/MAY/go-MAY/eth/tracers"
	"github.com/MAY/go-MAY/ethdb"
	"github.com/MAY/go-MAY/ethstats"
	"github.com/MAY/go-MAY/graphql"
	"github.com/MAY/go-MAY/internal/ethapi"
	"github.com/MAY/go-MAY/internal/flags"
	"github.com/MAY/go-MAY/les"
	"github.com/MAY/go-MAY/log"
	"github.com/MAY/go-MAY/metrics"
	"github.com/MAY/go-MAY/metrics/exp"
	"github.com/MAY/go-MAY/metrics/influxdb"
	...
	"github.com/MAY/go-MAY/p2p/netutil"
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/MAY/whisper")
	}
}
...
// RegisterEthService adds an MAY client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) ethapi.Backend {
	if cfg.SyncMode == downloader.LightSync {
		backend, err := les.New(stack, cfg)
		if err != nil {
			Fatalf("Failed to register the MAY service: %v", err)
		}
...
// RegisterEthStatsService configures the MAY Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the MAY Stats service: %v", err)
	}
}
