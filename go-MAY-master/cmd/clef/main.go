...
import (
	...
	"github.com/MAY/go-MAY/signer/core"
	"github.com/MAY/go-MAY/signer/fourbyte"
	"github.com/MAY/go-MAY/signer/rules"
	"github.com/MAY/go-MAY/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage MAY account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
