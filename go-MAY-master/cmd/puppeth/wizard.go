...
type wizard struct {
	...
	services map[string][]string   // MAY services known to be running on servers
...
// converts it to an MAY address. If an empty line is entered, the default
// value is returned.
