...
// setting up a new or managing an existing MAY private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your MAY private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new MAY network down to  |")
	...
	log.Info("Administering MAY network", "name", w.network)
