...
func makeMiner(genesis *core.Genesis) (*node.Node, *eth.MAY, error) {
	// Define the basic configurations for the MAY node
	...
	// Create the node and configure a full MAY node on it
