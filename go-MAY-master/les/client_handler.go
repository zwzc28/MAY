...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *LightMAY) *clientHandler {
...
func (h *clientHandler) handle(p *serverPeer) error {
	...
	if err := h.backend.peers.register(p); err != nil {
		p.Log().Error("Light MAY peer registration failed", "err", err)
		return err
	}
