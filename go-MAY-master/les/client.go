...
// Package les implements the Light MAY Subprotocol.
package les
...
import (
	...
	"github.com/MAY/go-MAY/common/mclock"
	...
	lpc "github.com/MAY/go-MAY/les/lespay/client"
	"github.com/MAY/go-MAY/light"
...
func New(stack *node.Node, config *eth.Config) (*LightMAY, error) {
...
// APIs returns the collection of RPC services the MAY package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightMAY) APIs() []rpc.API {
...
func (s *LightMAY) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightMAY) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightMAY) TxPool() *light.TxPool              { return s.txPool }
func (s *LightMAY) Engine() consensus.Engine           { return s.engine }
func (s *LightMAY) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightMAY) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightMAY) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *LightMAY) Protocols() []p2p.Protocol {
...
// light MAY protocol implementation.
func (s *LightMAY) Start() error {
